...
class DenunciaControllerTest < ActionController::TestCase
  ...
  test "should create denuncium" do
    assert_difference('Denuncium.count') do
      post :create, denuncium: { descripcion: @denuncium.descripcion, direccion: @denuncium.direccion, fecha: @denuncium.fecha }
    end
  ...
  test "should update denuncium" do
    patch :update, id: @denuncium, denuncium: { descripcion: @denuncium.descripcion, direccion: @denuncium.direccion, fecha: @denuncium.fecha }
    assert_redirected_to denuncium_path(assigns(:denuncium))
  end
